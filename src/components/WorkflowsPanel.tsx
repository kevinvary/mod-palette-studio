...
import { Play, Clock, CheckCircle2, AlertCircle, ArrowLeft, Save, MessageSquare, Maximize2, ImageIcon, ChevronRight, Minus, Plus, Sparkles, Cpu, Server, HardDrive, Activity, Zap } from "lucide-react";
